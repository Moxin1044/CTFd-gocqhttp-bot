...
class BaseChallenge(object):
    ...
    def solve(cls, user, team, challenge, request):
        ...
        db.session.commit()
        flag_true(challenge.name, challenge.category, str(challenge.value), user.name, submission, get_ip(request))
        group_flag_post(challenge.name, challenge.category, str(challenge.value), user.name, "解答成功")
    ...
    def fail(cls, user, team, challenge, request):
        ...
        db.session.commit()
        flag_error(challenge.name, challenge.category, str(challenge.value), user.name, submission, get_ip(request))
